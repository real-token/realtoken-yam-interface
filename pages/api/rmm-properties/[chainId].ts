...
import { APIPropertiesToken, PropertiesToken, RmmPropertiesToken } from "../../../src/types/PropertiesToken";
...
const getTokens = (chainId: number, communityProperties: APIPropertiesToken[]): RmmPropertiesToken[] => {
